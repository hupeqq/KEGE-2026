...
cluster1 = [dot for dot in dots if dot[0] < 16 and dot[1] > 16]
cluster2 = [dot for dot in dots if dot[0] < 15.2 and dot[1] < 9]
cluster3 = [dot for dot in dots if dot[0] > 15.2 and dot[1] < 11]
cluster4 = [dot for dot in dots if dot[0] > 22 and dot[1] > 12]
